...
export default function Slider() {
  ...
  const realIndex = index === 0 ? images.length - 1 : index === loop.length - 1 ? 0 : index - 1;

  return (
    <>
      <p ref={ref} className={visible ? "slider-text slider-fade visible" : "slider-text slider-fade"}>
